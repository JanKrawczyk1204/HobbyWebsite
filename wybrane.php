...
<head>
    <meta charset="utf-8" />
    <title>Wybane przez uzytkownika</title>
...
<body>
    ...
    <div id="content">
        <nav>
            ...
            <ol>
                ...
                if (!empty($_SESSION['user_id']))
                {
                    ...
                    echo '<li><a class="menu" id="active" href="wybrane.php">Wybrane</a></li>';
                }
        ...
        <div id="wrapper">
            <h1>Wybrane przez Ciebie</h1>
            <?php require 'wyswietlanie_wybranych.php'?> 
        </div>
    </div>
</body>
</html>